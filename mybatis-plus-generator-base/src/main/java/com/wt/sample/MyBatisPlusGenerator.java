 ...
 * @description: 代码生成核心代码
 * @author: wt
 * @create: 2022-03-17 10:55
 **/
@Component
public class MyBatisPlusGenerator {
    //作者名
    private static final String AUTHOR = "wt";
    //表table的前缀，不加到生成的类名中
    private static final String PREFIX = "t_";
    //功能模块名称，生成的文件会存放到模块下
    private static final String MODULE_NAME = "test";
    //要生成的表名
//    private static final String[] TABLES= {"FSZ_DIM_DWYS","FSZ_DIM_UNIT"};
    private static final String[] TABLES= {"FSZ_ODS_RPT_ORG_STAT","FSZ_ODS_RPT_ORG_STAT_DETAIL"};

    private static final String BASE_PACKAGE = "com.ludan.demo";
...
//    private static final String JDBC_USERNAME = "sysdba";
//    private static final String JDBC_PASSWORD = "123456789";


    private static final String JDBC_URL = "jdbc:dm://10.10.20.152:5236" ;
    private static final String JDBC_DRIVER = "dm.jdbc.driver.DmDriver";
    private static final String JDBC_USERNAME = "SDDSJ";
    private static final String JDBC_PASSWORD = "UFSJFW@20231010";
...
//        dataSourceConfig.setDbType(DbType.MYSQL);
        dataSourceConfig.setDbType(DbType.DM);
         dataSourceConfig.setSchemaName("SZ_DSJ");
